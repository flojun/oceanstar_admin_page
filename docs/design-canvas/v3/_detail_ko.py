...
# (제목, 설명 줄들, 사진 묶음 key, 양 끝 표시)
# 픽업·복귀는 흐름 밖 카드였다. 순서 안으로 들여 처음과 끝에 두었다.
# 옛 FLOW_NOTE('기사님이 성함을…')는 픽업 단계의 둘째 줄로 들어갔다.
JOURNEY = [
    ("호텔 픽업", ["와이키키 내 가장 가까운 지정 픽업 장소로 안내드립니다.",
                "기사님이 성함을 호명하시면 오션스타 확인 후 탑승해주세요."], None, "van"),
    ("출항", [], "boat", None),
    ("다이아몬드헤드 크루즈", [], None, None),
    ("거북이 스노클링", [], "turtle", None),
    ("해양 5종", [], "acts", None),
    ("간식 & 인생샷", [], None, None),
    ("와이키키 크루즈", [], "drone", None),
    ("도착", [], None, None),
    ("호텔 복귀", ["투어 후 픽업 장소로 안전하게 모셔다 드립니다."], None, "hotel"),
]

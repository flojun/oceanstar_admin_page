  ...
  return (
    <div className="fixed inset-0 flex flex-col text-slate-800 font-sans selection:bg-sky-200 selection:text-sky-900">
      ...
      <header className="w-full z-40 shrink-0 pt-4 px-4 sm:px-8 mb-[-80px] sm:mb-[-100px] pointer-events-none relative">
        <div className={`pointer-events-auto max-w-[1300px] mx-auto px-6 sm:px-8 py-2.5 sm:py-3 flex items-center justify-between gap-3 relative transition-all duration-500 rounded-[2.5rem] ${isScrolled ? 'bg-white/30 backdrop-blur-[40px] shadow-[0_8px_32px_0_rgba(0,0,0,0.1)] border border-white/50' : 'bg-white/10 backdrop-blur-md border border-white/20 shadow-lg'}`}>
          ...
          <nav className="hidden lg:flex flex-1 min-w-0 justify-center items-center gap-3 xl:flex-none xl:absolute xl:left-1/2 xl:top-1/2 xl:-translate-x-1/2 xl:-translate-y-1/2 xl:gap-6 2xl:gap-8 font-bold text-[15px] text-slate-700 whitespace-nowrap">

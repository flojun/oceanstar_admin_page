...
const faqDataKo = [
  ...
  },
  {
    ...
    items: [
      {
        q: "취소 및 환불 규정이 어떻게 되나요? (특약 적용 상품)",
        a: "오션스타 (Waikiki Turtle Snorkel) | 하와이 현지 시간 기준\n\n[기본 환불 특약 규정]\n본 상품은 국외여행 표준약관 제6조(특약)에 따라 일반 소비자분쟁해결기준과 다른 취소수수료가 적용됩니다. 예약 전 취소 규정을 반드시 확인해 주세요.\n\n[환불 규정 상세]\n- 여행시작 7일 전까지 (~7일) : 여행 요금 전액 환불\n- 여행시작 3일 전까지 (6~3일) : 상품 요금의 50% 공제\n- 여행시작 당일까지 (2일~당일) : 취소/환불 불가\n\n※ 여행일은 하와이 현지 시각 기준입니다."
      },
      {
        q: "날씨로 인해 투어가 취소되면 어떻게 되나요?",
        a: "가벼운 비나 우천 시에도 와이키키 유일의 루프탑 보트로 투어는 정상 진행됩니다. 다만 태풍, 극심한 악천후, 또는 해안경비대의 출항 금지 등 안전상의 이유로 투어가 취소될 경우, [전액 환불] 또는 [날짜 변경] 중 고객님이 원하시는 쪽으로 선택하실 수 있습니다. 취소 여부는 당일 오전 현지 상황에 따라 사전 통보해 드립니다."
      },
      {
        q: "프라이빗 / 단체 예약의 경우 환불 규정은요?",
        a: "일반 투어와 동일한 환불 규정이 적용됩니다. 다만 별도의 계약을 체결한 경우에는 해당 계약의 조항이 우선하며, 사전에 문의해 주시면 일정 조정 등을 최대한 도와드립니다."
      }
    ]
  },
  {
...
const faqDataEn = [
  {
    category: "Participation & Safety",
    items: [
      { q: "Can I participate even if I can't swim at all?", a: "Yes! Our Korean-speaking crew will provide high-buoyancy life jackets and assist you right next to you in the water. We safely guide you to the turtles. Many non-swimmers tell us it was their best decision. You can also just enjoy from the boat." },
      { q: "Can children join? From what age?", a: "Children 24 months and older can participate. Minors must be accompanied by a guardian. Our crew takes excellent care of kids, making this tour highly rated by families." },
      { q: "Can pregnant women participate?", a: "If your health is fine, yes. Boat rides and turtle snorkeling are generally safe, just avoid overly strenuous activities." },
      { q: "I get seasick easily, will it be okay?", a: "Please take motion sickness medicine an hour before. The ride to Turtle Canyon is only 15-20 minutes. Our 51-passenger boat is very stable compared to smaller vessels." },
      { q: "Is it okay for seniors?", a: "Yes, if in good health. Individuals with heart/joint conditions should inquire before booking. You can also choose to only watch from our stable boat without snorkeling." }
    ]
  },
  {
    category: "Booking & Operation",
    items: [
      { q: "How do I receive confirmation?", a: "We will send a confirmation message with pickup details via the booking platform or KakaoTalk/WhatsApp. No need to print out a voucher." },
      { q: "Where is the pickup?", a: "We pick up from main hotels in Waikiki or nearby designated spots. We will provide exact time and location upon confirmation." },
      { q: "Can I book for just 1 person?", a: "Yes. However, general tours require a minimum of 10 people to depart. If the minimum isn't met, we will offer a reschedule or refund." },
      { q: "Which is better: Morning 1 or Morning 2?", a: "Morning 1 (07:30) is best for calm waters and active turtles. Morning 2 (10:30) is great for those who want a relaxed morning start." },
      { q: "Can I book on the same day?", a: "We highly recommend booking weeks in advance, especially during peak seasons. Same-day bookings might be difficult due to limited capacity." }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      { q: "What should I bring?", a: "Just your swimsuit and a towel! We provide snorkeling gear, life jackets, ramen, snacks, and drinks for free. We recommend bringing sunscreen and a light jacket." },
      { q: "Is photography available?", a: "We take free photos on the boat. You can also rent a GoPro ($40, SD card included), and our crew will take close-up underwater photos of you with the turtles." },
      { q: "Are there restrooms or showers?", a: "Yes, there is a restroom on the boat. Public restrooms and showers are also available at Kewalo Harbor park." }
    ]
  },
  {
...
export default function FAQSection({ lang }: { lang: Language }) {
  const activeFaqData = lang === 'en' ? faqDataEn : faqDataKo;
    ...
    <section className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 mt-20 mb-20 relative z-30">
      <div className="text-center mb-12">
        <h2 className="text-3xl md:text-5xl font-extrabold text-slate-900 mb-4 tracking-tight flex items-center justify-center gap-3">
          ...
          {lang === 'en' ? 'Frequently Asked Questions (FAQ)' : '자주 묻는 질문 (FAQ)'}
        </h2>
        <p className="text-lg text-slate-500 max-w-2xl mx-auto">
          {lang === 'en' ? 'Here are the most common questions organized by category.' : '예약 전 가장 궁금해하시는 질문들을 카테고리별로 모았습니다.'}
        </p>
      </div>

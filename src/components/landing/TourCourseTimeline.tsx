...
const courseDataKo: TimelineItem[] = [
  {
    title: "호텔 픽업",
    duration: "20분 소요",
...
const courseDataEn: TimelineItem[] = [
  {
    title: "Hotel Pickup",
    duration: "20 min",
    description: "Aloha! Our Korean guide will pick you up at the closest location to your hotel. Exact times provided individually.",
    imgSrc: "/images/timeline/pickup.png"
  },
  {
    title: "Arrive at Kewalo Harbor",
    description: "Board our tour boat at beautiful Kewalo Harbor, just 15 minutes away from Waikiki.",
    imgSrc: "/images/timeline/harbor.png"
  },
  {
    title: "Turtle Snorkeling",
    duration: "180 min",
    description: "Snorkel with wild sea turtles and diverse Pacific marine life at Waikiki Turtle Canyon.",
    imgSrc: "/images/timeline/snorkeling.png"
  },
  {
    title: "Stand Up Paddleboard",
    description: "Try SUP in the ocean in front of Waikiki. A great core workout is a bonus!",
    imgSrc: "/images/timeline/paddleboard.png"
  },
  {
    title: "Sea Kayak",
  ...
  },
  {
    ...
    duration: "20 min",
    description: "Sadly, the trip ends here. We'll drop you off safely back at your Waikiki hotel. Keep these special memories forever!",
    imgSrc: "/images/timeline/dropoff.png"
  }
];
...
export default function TourCourseTimeline({ isSunset = false, lang }: { isSunset?: boolean, lang: Language }) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto py-4 px-2 sm:px-6">
      <h3 className="text-2xl font-black text-slate-900 border-b-2 border-slate-900 pb-3 mb-8">{lang === 'en' ? 'Tour Itinerary' : '코스 일정'}</h3>

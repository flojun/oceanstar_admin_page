...
import { ChevronLeft, ChevronRight, Save, Plus, Trash2, GripVertical, Image as ImageIcon, Loader2, CalendarDays, ClipboardCheck } from "lucide-react";
    ...
    return (
        <div className="p-2 md:p-6 space-y-4 max-w-[1800px] mx-auto w-full">
            ...
            <div className="flex gap-1 bg-gray-100 p-1.5 rounded-xl">
                <Link
                    href="/dashboard/crew"
                    className="flex-1 flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg text-sm font-semibold transition-all duration-200 bg-green-700 text-white shadow-md"
                >
                    <CalendarDays className="w-4 h-4" />
                    스케쥴 관리
                </Link>
                <Link
                    href="/dashboard/crew/attendance"
